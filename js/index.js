...
var Config = {
  ...
  Init: function() {
    ...
    $.ajaxSetup({type: 'POST', cache: false, dataType: 'jsonp', timeout: 5000});
  }
};
...
var Navigator = new(function() {
  this.Init = function() {
    ...
    $('.menudiv a').on('click', function() {
      Navigator.load($(this).attr('id').replace('menu_', ''));
    });
...
var PortfolioVM = new(function() {
  ...
  self.AddMarker = function() {
    ...
    google.maps.event.addListener(newMarker, 'click', function() {
      var content = '<div class="pitem" style="background-image: ' + this.item.tumbcss + '; margin: 5px;" idx="' + this.item.idx + '">' + '<div class="pitemtitle">' + this.item.title + '</div>' + '</div>';
